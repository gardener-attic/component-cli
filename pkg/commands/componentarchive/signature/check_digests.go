...
func NewCheckDigest(ctx context.Context) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "fetch the component descriptor from a oci registry and check digests",
		Long: `
...
func (o *CheckDigestsOptions) Run(ctx context.Context, log logr.Logger, fs vfs.FileSystem) error {
	...
	if err := verify.CheckCd(cd, *repoCtx, ociClient, context.TODO(), o.SkipAccessTypes); err != nil {
